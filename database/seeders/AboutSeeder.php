...
class AboutSeeder extends Seeder
{
    ...
    public function run()
    {
        About::create([
            ...
            'address'=>'Lahore, PAK',
            'freelance'=>'Available',
            'detail'=>'Love To Work with PHP (Laravel), C#  and like to work with those people who really want quality in their Environment. Only work is not the thing that impress anyone But uniqueness and efficiencies does. Curious and interested in learning cutting edge Technologies.',
