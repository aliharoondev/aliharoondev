                            ...
                            <form method="post" action="{{route('education.store')}}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col form-group">
                                        ...
                                        <input type="text" id="batch" name="batch" class="form-control @error('batch') is-invalid @enderror" value="{{old('batch')}}" placeholder="Batch"/>
                                        @error('batch')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col text-right">
                                        <input type="submit" class="btn btn-primary input-lg" value="Add New Education"/>
                                    </div>
                                </div>
                            </form>
                        </div>
