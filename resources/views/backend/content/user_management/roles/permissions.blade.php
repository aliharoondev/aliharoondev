...
@section('styles')
{{--    <link href="{{ URL::asset('backend/theme/vendors/datatables/datatables.bundle.css')}}" rel="stylesheet" type="text/css"/>--}}
    <link rel="stylesheet" href="{{URL::asset('backend/theme/global/sumoselect/sumoselect.css')}}" rel="stylesheet" type="text/css">
    <style>
        .SumoSelect {
            color: black;
            width: 90%;
...
@stop
@section('scripts')
    <script src="{{URL::asset('backend/theme/global/sumoselect/sumoselect.js')}}"></script>
    <script>
