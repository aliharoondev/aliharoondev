                            ...
                            <form action="{{route('portfolio-details.update',$portfolio_detail->id)}}" method="post" eenctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col form-group">
                                        ...
                                        <input type="text" id="project_url" name="catproject_urlegory" class="form-control @error('project_url') is-invalid @enderror" value="{{old('project_url')}}" placeholder="Project Url"/>
                                        @error('project_url')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
