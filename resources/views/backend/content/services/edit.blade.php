        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <form action="{{route('services.update',$service->id)}}" method="post" eenctype="multipart/form-data">
                                @csrf
                                @method('PATCH')
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col text-right">
                                        <input type="submit" class="btn btn-primary input-lg" value="Update Services"/>
                                    </div>
                                </div>
                            </form>
                        </div>
