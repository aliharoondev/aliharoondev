;(function ($) {
    ...
    !function (t, e) {
        ...
        var h = /(?=.*chrome)(?=.*android)/i.test(navigator.userAgent), g = {
            init: function () {
                ...
                var e, i, a, n = this, o = this.settings, r = window.getSelection(),
                    d = "mix" == o.mode && !o.enforceWhitelist, c = !o.whitelist || !o.whitelist.length,
                ...
                if (t = void 0 === t ? this.state.inputText : t, (!c || d || o.templates.dropdownItemNoMatch) && !1 !== o.dropdown.enable && !this.state.isLoading) {
                    if (clearTimeout(this.dropdownHide__bindEventsTimeout), this.suggestedListItems = this.dropdown.filterListItems.call(this, t), t && !this.suggestedListItems.length && (this.trigger("dropdown:noMatch", t), o.templates.dropdownItemNoMatch && (a = o.templates.dropdownItemNoMatch.call(this, {value: t}))), !a) {
                        if (this.suggestedListItems.length) t && d && !this.state.editing.scope && !s(this.suggestedListItems[0].value, t) && this.suggestedListItems.unshift({value: t}); else {
                ...
                var e = this, i = this.DOM, s = i.scope, a = i.dropdown,
                ...
                if ("manual" != this.settings.dropdown.position) {
                    var e, i, s, a, n, o, r, l = this.DOM.dropdown, d = document.documentElement.clientHeight,
                ...
                var e = this, i = this.settings.dropdown, s = i.clearOnSelect, a = i.closeOnSelect;
                ...
                if (this.trigger("dropdown:select", {data: o, elm: t}), n && o) {
                    if (this.state.editing ? this.onEditTagDone(null, d({__isValid: !0}, o)) : this["mix" == this.settings.mode ? "addMixTags" : "addTags"]([o], s), setTimeout((function () {
                ...
                var i, s, a, n, o, r = this, d = this.settings, h = d.dropdown, g = (e = e || {}, []), u = d.whitelist,
                    p = h.maxItems || 1 / 0, f = h.searchKeys, m = 0;
                ...
                for (o = h.caseSensitive ? "" + t : ("" + t).toLowerCase(); m < u.length && (i = u[m] instanceof Object ? u[m] : {value: u[m]}, h.fuzzySearch && !e.exact ? (a = f.reduce((function (t, e) {
                    return t + " " + (i[e] || "")
        ...
        var p = {
            customBinding: function () {
                ...
                var t, e = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0],
                    i = this.events.callbacks, s = e ? "addEventListener" : "removeEventListener";
                ...
                onFocusBlur: function (t) {
                    var e = t.target ? this.trim(t.target.textContent) : "", i = this.settings, s = t.type,
                        ...
                        r = this.state.actions.addNew && a, l = window.getSelection();
                    if ("blur" == s) {
                    ...
                    if (this.trigger("keydown", {originalEvent: this.cloneEvent(t)}), "mix" == this.settings.mode) {
                        switch (t.key) {
                            ...
                            case"Backspace":
                                ...
                                var s, o, r = document.getSelection(),
                                    ...
                                    c = a(this.DOM.input.innerHTML), g = this.getTagElms();
                                ...
                                this.isFirefox && 1 == r.anchorNode.nodeType && 0 != r.anchorOffset && (this.removeTags(), this.placeCaretAfterNode(this.setRangeAtStartEnd())), setTimeout((function () {
                                    var t = document.getSelection(), i = a(e.DOM.input.innerHTML),
                    ...
                    var e, i, s, a, n, o, r, l, c = this, g = this.settings, u = this.value.length,
                        p = this.getTagElms(), f = document.createDocumentFragment(),
                        m = window.getSelection().getRangeAt(0), v = [].map.call(p, (function (t) {
                    ...
                    var s = t.closest("." + this.settings.classNames.tag), a = this.getNodeIndex(s),
                        n = this.tagData(s), o = this.input.normalize.call(this, t),
                    ...
                    r || !0 !== t.originalIsValid || (l = !0), s.classList.toggle(this.settings.classNames.tagInvalid, !0 !== l), n.__isValid = l, s.title = !0 === l ? n.title || n.value : l, o.length >= this.settings.dropdown.enabled && (this.state.editing && (this.state.editing.value = o), this.dropdown.show.call(this, o)), this.trigger("edit:input", {
                        tag: s,
                        index: a,
                        data: d({}, this.value[a], {newValue: o}),
                    ...
                    if (this.state.hasFocus || this.toggleFocusClass(), this.DOM.scope.contains(t)) {
                        var s, a = this.settings, n = t.closest("." + a.classNames.tag),
                            o = this.input.normalize.call(this, t), r = this.tagData(n).__originalData,
                        ...
                        } else this.onEditTagDone(n, r); else this.onEditTagDone(n)
                    }
        ...
        return f.prototype = {
            ...
            applySettings: function (t, e) {
                ...
                })), "autoComplete" in e && !l(e.autoComplete) && (i.autoComplete = this.DEFAULTS.autoComplete, i.autoComplete.enabled = e.autoComplete), "mix" == i.mode && (i.autoComplete.rightKey = !0, i.delimiters = e.delimiters || null, i.tagTextProp && !i.dropdown.searchKeys.includes(i.tagTextProp) && i.dropdown.searchKeys.push(i.tagTextProp)), t.pattern) try {
            ...
            getCaretGlobalPosition: function () {
                ...
                if (t.rangeCount) {
                    var e, i, s = t.getRangeAt(0), a = s.startContainer, n = s.startOffset;
            ...
            editTag: function (t, e) {
                ...
                var n = a(), o = this.getNodeIndex(t), r = this.tagData(t), l = this.events.callbacks, c = this, h = !0;
                if (n) {
            ...
            normalizeTags: function (t) {
                var s = this, a = this.settings, n = a.whitelist, o = a.delimiters, r = a.mode, l = a.tagTextProp,
                    d = a.enforceWhitelist, c = [], h = !!n && n[0] instanceof Object, g = t instanceof Array,
                    u = function (t) {
            ...
            parseMixTags: function (t) {
                var e = this, i = this.settings, s = i.mixTagsInterpolator, a = i.duplicates, n = i.transformTag,
                    o = i.enforceWhitelist, r = i.maxTags, l = i.tagTextProp, d = [];
                return t = t.split(s[0]).map((function (t, i) {
                    var c, h, g, u = t.split(s[1]), p = u[0], f = d.length == r;
                    try {
                        if (p == +p) throw Error;
                        h = JSON.parse(p)
                    } catch (t) {
            ...
            addMixTags: function (t) {
                var e, i = this, s = this.settings, a = this.state.tag.delimiters;
                ...
                }), this.isFirefox ? 100 : 0), this.state.tag = null, this.trigger("add", d({}, {tag: e}, {data: t[0]})), e
            },
            ...
            createTagElem: function (t) {
                var e, i = d({}, t, {value: o(t.value + "")});
                return this.settings.readonly && (t.readonly = !0), function (t) {
            ...
            reCheckInvalidTags: function () {
                ...
                [].forEach.call(s, (function (e) {
                    var i = t.tagData(e), s = e.getAttribute("title") == t.TEXTS.duplicate, a = !0 === t.validateTag(i);
            ...
            update: function (t) {
                var e, i, s = this.DOM.originalInput, a = (t || {}).withoutChangeEvent,
